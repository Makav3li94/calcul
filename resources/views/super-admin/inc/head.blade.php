...
{{--    <link rel="shortcut icon" type="image/png" href="img/ico/favicon-32.png">--}}
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin/vendors/css/toastr.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/vendors/css/tables/datatable/datatables.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/vendors/css/tables/datatable/responsive.dataTables.min.css')}}">
    @yield('styles')
