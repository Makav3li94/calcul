...
@endsection
@section('content')
    <form class="form" method="post" action="{{route('super-admin.blogs.update',$blog->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title-wrap bar-success">
                            <h4 class="card-title" id="basic-layout-form">ویرایش خبر</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="px-3">
                            <div class="form-body">
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <textarea name="excerpt" class="form-control" id="" cols="3" rows="2" placeholder="خلاصه خبر">{{$blog->excerpt}}</textarea>
                                        </div>
                            ...
                            <div class="form-body">
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        <textarea name="body" rows="10" placeholder="متن بلاگ ... " class="summernote">{!! $blog->body !!}</textarea>
                                    </div>
                                    @if($errors->has('body'))
